...
class interface_rouge 
{
	...
	duration = 10e10;
	movingEnable = 0;
	onLoad = "uiNamespace setVariable ['interface_rouge', _this select 0]";
	onUnload = "uiNamespace setVariable ['interface_rouge', objNull]";
	onDestroy = "uiNamespace setVariable ['interface_rouge', objNull]";
	class controls 
	{
		class image_rouge: RscPicture
		{
			idc = 1000;
			text = "TA-image\interface_rouge.paa";
		...
		class RscStructuredText_1101: RscStructuredText
		{
			idc = 1004; // kill/mort
			text = ""; //--- ToDo: Localize;
			x = 0.191878 * safezoneW + safezoneX;
			y = 0.886021 * safezoneH + safezoneY;
			w = 0.0361079 * safezoneW;
			h = 0.0329909 * safezoneH;
			colorBackground[] = {-1,-1,-1,0};
			class Attributes {
				align="center";
				color="#FFFFF";
