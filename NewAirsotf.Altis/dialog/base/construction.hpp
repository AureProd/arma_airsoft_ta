class constructionDialog
{
	...
	class textBar: RscText
	{
		...
		colorBackground[] = {0.46,0.02,0.1,1};
...
class constructionAdminDialog
{
	idd = -1;
	movingEnable = true;
	moving = 1;
	onLoad = "with uiNameSpace do { constructionAdminDialog = _this select 0 }";
	controls[] = {textBar,RscListbox_1500,RscText_1001,buyButton,destroyButton,nearList,Movebutton,nearstuff,snap};
	controlsBackground[] = {IGUIBack_2200};
	...
	{
		idc = 1600;
		action = "call construction_PurchaseAdmin";
	...
	{
		idc = 1610;
		action = "call construction_RemoveAdmin";
