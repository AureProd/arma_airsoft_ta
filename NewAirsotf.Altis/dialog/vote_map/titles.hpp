...
class gungame_mapvotedfor
{
	...
	class controls
	{
		...
		{
			idc = 0;
			text = "YOU VOTED FOR BLUE PEAR HARBOUR"; //--- ToDo: Localize;
...
class EndScreen
{
	...
	class controls {
		...
		{
			idc = -1;
			text = "VOS STATISTIQUES"; //--- ToDo: Localize;
		...
		{
			idc = -1;
			text = "Le prochain tour dans quelques secondes"; //--- ToDo: Localize;
		...
		class RscText_1005: RscText
		{
			...
			x = 0.437830 * safezoneW + safezoneX;
...
class EndScreen_bis
{
	...
	fadein=0;
	duration = 9999999;
	onLoad = "uiNamespace setVariable ['gg_endscreen_bis',_this select 0]";

	class controls {
		class txtWinner_bis: RscStructuredText
		{
			idc = 0;
			x = 0.149375 * safezoneW + safezoneX;
			y = 0.159 * safezoneH + safezoneY;
		...
		class RscText_1000_bis: RscText
		{
			idc = -1;
			x = 0.396875 * safezoneW + safezoneX;
			y = 0.412 * safezoneH + safezoneY;
		...
		class RscText_1001_bis: RscText
		{
			idc = -1;
			x = 0.396875 * safezoneW + safezoneX;
			y = 0.379 * safezoneH + safezoneY;
		...
		class RscText_1002_bis: RscText
		{
			idc = -1;
			text = "VOS STATISTIQUES"; //--- ToDo: Localize;
			x = 0.402031 * safezoneW + safezoneX;
		...
		class RscText_1003_bis: RscText
		{
			idc = -1;
			x = 0.396875 * safezoneW + safezoneX;
			y = 0.577 * safezoneH + safezoneY;
		...
		class RscText_1004_bis: RscText
		{
			idc = -1;
			text = "Le prochain tour dans quelques secondes"; //--- ToDo: Localize;
			x = 0.400875 * safezoneW + safezoneX;
		...
		class RscText_1005_bis: RscText
		{
			idc = -1;
			text = "Hit"; //--- ToDo: Localize;
			x = 0.437830 * safezoneW + safezoneX;
		...
		class RscText_1008_bis: RscText
		{
			idc = -1;
			text = "Morts"; //--- ToDo: Localize;
			x = 0.437830 * safezoneW + safezoneX;
		...
		class levelreached_bis: RscText
		{
			idc = 3;
			text = ""; //--- ToDo: Localize;
			x = 0.402031 * safezoneW + safezoneX;
		...
		class RscText_1010_bis: RscText
		{
			idc = -1;
			text = "crédits"; //--- ToDo: Localize;
			x = 0.437830 * safezoneW + safezoneX;
